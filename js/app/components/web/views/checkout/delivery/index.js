...
export default class Deliverydetails extends Component {
    ...
    render() {
        ...
        return ( <
            ...
            option value = "AF" > Pardesh - 1 < /option> <
            option value = "AX" > Pardesh - 2 < /option> <
            option value = "AL" > Pardesh - 3 < /option> <
            /select> <
            /div> <
            /div> <
            div className = "col-sm-6" >
            ...
            option value = "JAL" > Jaleswar < /option> <
            option value = "SIR" > Sirha < /option> <
            option value = "RJ" > Rajbiraj < /option> <
            /select> <
            /div> <
            /div> <
            div className = "col-sm-6" >
            ...
            <
            textarea className = "form-control border-form-control"
            name = "address"
            value = {
                address
            }
