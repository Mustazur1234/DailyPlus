...
export default class Login extends Component {
    ...
    render() {
        ...
        return ( <
            ...
            noValidate >
            <
            div className = "login-modal-right" > { /* Tab panes */ } <
            ...
            data - toggle = "tab"
            href = "#login"
            role = "tab" > < i className = "mdi mdi-lock" / > LOGIN < /a> <
            /li> <
            li className = "nav-item" >
            <
            a className = "nav-link"
            href = "/register" > < i className = "mdi mdi-pencil" / > REGISTER < /a> <
            /li> <
            /ul> <
            /div> <
            div className = "clearfix" / >
