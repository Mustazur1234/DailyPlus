...
export default class Profile extends Component {
    ...
    render() {
        ...
        return ( <
            ...
            aria - current = "page" > My profile < /li> <
            /ol> <
            /nav> <
            /div> <
            /div> <
            ...
            className = "user-item active" > < i className = "mdi mdi-account-outline" / > My profile < /a> <
            ...
            <
            input className = "form-control border-form-control"
            type = "text"
            name = "firstName"
            value = {
                user.firstName
            ...
            htmlFor = "exampleRadios1" > Male < /label> <
            /div> <
            div className = "custome-radio form-check-inline" > {
                user.gender === "Female" ?
                <
            ...
            label className = "form-check-label"
            htmlFor = "exampleRadios2" > Female < /label> <
            /div> <
            /div> <
            /div> <
            /div> <
            ...
            <
            button type = "button"
            className = "btn btn-danger btn-lg" > Cencel < /button> <
            button type = "button"
