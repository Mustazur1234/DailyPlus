...
export default class Reward extends Component {
    ...
    render() {
        return ( <
            ...
            aria - current = "page" > User Dashboard < /li> <
            /ol> <
            /nav> <
            /div> <
            /div> <
            ...
            <
            img src = "images/avatar/img-5.jpg"
            alt / >
            <
            ...
            <
            div className = "earn-points" > < img src = "images/Dollar.svg"
            alt / > Points: < span > 20 < /span></div >
            <
            /div> <
            /div> <
            /div> <
            ...
            a href = "/account/order/list"
            className = "user-item" > < i className = "uil uil-box" / > My Orders < /a> <
            a href = "/account/rewards"
            className = "user-item active" > < i className = "uil uil-gift" / > My Rewards < /a> <
            ...
            span className = "date-reward" > Expires on: 31 st May < /span> <
            /div> <
            div className = "top-coup-code"
            title = "Coupon Code" > Gambocoup25 < /div> <
            /div> <
            /div> <
            div className = "col-lg-4 col-md-12" >
            <
            ...
            span className = "date-reward" > Expires on: 25 th May < /span> <
            /div> <
            div className = "top-coup-code"
            title = "Coupon Code" > Gambocoup10 < /div> <
            /div> <
            /div> <
            div className = "col-lg-4 col-md-12" >
            <
            ...
            span className = "date-reward" > Expired on: 5 th May < /span> <
            /div> <
            div className = "top-coup-code"
            title = "Coupon Code" > Gambocoup15 < /div> <
            /div> <
            /div> <
            div className = "col-lg-4 col-md-12" >
            <
            ...
            span className = "date-reward" > Expires on: 20 th May < /span> <
            /div> <
            div className = "top-coup-code"
            title = "Coupon Code" > Gambocoup5 < /div> <
            /div> <
            /div> <
            div className = "col-lg-4 col-md-12" >
            <
